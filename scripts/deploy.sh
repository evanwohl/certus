...
echo "2. Configure executor: Update executor/config.yml with contract address"
echo "3. Configure verifier: Update verifier/config.yml with contract address"
echo "4. Start nodes: ./gradlew :executor:run & ./gradlew :verifier:run"
echo ""
